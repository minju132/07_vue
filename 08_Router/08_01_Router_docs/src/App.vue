...
// 브라우저 주소창에 # 해시 부분 변경을 감지하고 이벤트가 발생했을 때 실행할 콜백함수를 등록하는 리스너
...
// routes에 key를 기반으로 컴포넌트를 리턴하여 화면에 렌더링하기 위한 목적
...
<!--
  ...
  이는 vue에서 브라우저의 기본동작을 방지하기 위함으로 만약 #을 추가하지 않으면
  자바스크립트를 사용하여 네비게이션을 제어하기되며 기존 방식대로 서버 라우팅을 처리하게 된다.
